...
// But for this example we'll just do it this way
  ...
  echo "<h1>Release Escrow Funds</h1>\n";
  echo "<p>Want to release your escrow payment?</p>\n";
  
  //table.to.input.price
echo " <h2>Enter Escrow Information Below:</h2><p> \n"; 
echo " <form action=\"release.php\" method=\"post\" enctype=\"application/x-www-form-urlencoded\"
> \n"; 
echo " <table> \n"; 
